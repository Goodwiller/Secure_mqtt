# Result Evaluation Metric 4 (REM4): Time required by
# a client to subscribe to a topic with 1 existing member
# without taking in account the exchange of messages
# over the network. (Averaged out for 100 iterations) (only rekey event)
...
script_path = "C:/Users/iamra/Desktop/Secure_mqtt/secure_mqtt_using_hash_chaining_and_xor_operations/REM3_4_client_subscribe.py"
